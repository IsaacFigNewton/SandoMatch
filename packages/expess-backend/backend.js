...
const findSandwichById = (id) =>
  sandwiches["sandwiches_list"].find(
...
app.get("/sandwiches/random", (req, res) => {
  const randomIndex = Math.floor(
    Math.random() * sandwiches.sandwiches_list.length
  );
  const randomSandwich =
    sandwiches.sandwiches_list[randomIndex];
  if (randomSandwich) {
...
app.get("/sandwiches/sort", (req, res) => {
  ...
  //Ascending
  const sortByNameAscending = sandwiches[
    "sandwiches_list"
  ].toSorted((a, b) => a.name.localeCompare(b.name));
  const sortByRatingAscending = sandwiches[
    "sandwiches_list"
  ].toSorted((a, b) => a.rating - b.rating);
  const sortByCaloriesAscending = sandwiches[
    "sandwiches_list"
  ].toSorted((a, b) => a.calories - b.calories);
  const sortByCostAscending = sandwiches[
    "sandwiches_list"
  ].toSorted((a, b) => a.cost - b.cost);
  //Descending
  const sortByNameDescending = sandwiches[
    "sandwiches_list"
  ].toSorted((a, b) => b.name.localeCompare(a.name));
  const sortByRatingDescending = sandwiches[
    "sandwiches_list"
  ].toSorted((a, b) => b.rating - a.rating);
  const sortByCaloriesDescending = sandwiches[
    "sandwiches_list"
  ].toSorted((a, b) => b.calories - a.calories);
  const sortByCostDescending = sandwiches[
    "sandwiches_list"
...
app.post("/sandwiches/preferences", (req, res) => {
  ...
  const filteredSandwiches = sandwiches.sandwiches_list.filter(
    (sandwich) => {
  ...
  sandwiches_list: [
    ...
    },
    {
      ...
      ingredients: {
        ...
        spices: {
          "black pepper": ["black pepper"],
          salt: ["coarse salt", "unsalted butter"]
        }
      },
      cost: 3.9,
      calories: 425,
    ...
    },
    {
      ...
      ingredients: {
        ...
        cheeses: {},
        vegetables: {
          pepper: ["roasted red pepper", "crushed red pepper"],
          spinach: ["spinach leave"]
        },
        condiments: {
    ...
    },
    {
      ...
      ingredients: {
        breads: {},
        meats: {
          chicken: ["boneless skinless chicken breast halve"]
        },
        cheeses: {
    ...
    },
    {
      ...
      ingredients: {
        breads: {
          "white bread": ["toasted white bread"]
        },
        meats: {
          tuna: ["tuna salad"]
        },
    ...
    },
    {
      ...
      ingredients: {
        ...
        meats: {},
        cheeses: {
          "cream cheese": ["dill cream cheese"]
        },
        vegetables: {
          cucumber: ["cucumber"]
        },
    ...
    },
    {
      ...
      ingredients: {
        ...
        condiments: {
          mustard: ["mustard-dill sauce"]
        },
        spices: {
          dill: ["mustard-dill sauce"]
        }
      },
      cost: 3.2,
      calories: 240,
    ...
    },
    {
      ...
      ingredients: {
        ...
        meats: {
          bratwurst: ["beer-braised bratwurst"]
        },
        cheeses: {},
        vegetables: {
          onion: ["caramelized onion"]
    ...
    },
    {
      ...
      ingredients: {
        ...
        meats: {},
        cheeses: {
          swiss: ["vegan swiss cheese"]
        },
        vegetables: {},
        condiments: {
          dressing: ["vegan thousand island dressing"]
        },
        spices: {}
      },
      cost: 4.2,
    ...
    },
    {
      ...
      ingredients: {
        ...
        meats: {
          sausage: ["merguez sausage"]
        },
        cheeses: {},
        vegetables: {
          pepper: ["roasted bell pepper"]
        },
        condiments: {},
        spices: {
          sage: ["merguez sausage"]
        }
      },
      cost: 4.2,
      calories: 455,
    ...
    },
    {
      ...
      ingredients: {
        ...
        meats: {
          shawarma: ["shawarma-spiced cauliflower"]
        },
        cheeses: {},
        vegetables: {
          pickle: ["pickled turnip"]
    ...
    },
    {
      ...
      ingredients: {
        ...
        condiments: {
          chutney: ["mint chutney", "tamarind chutney"]
        },
        spices: {}
      },
      cost: 3.6,
    ...
    },
    {
      ...
      ingredients: {
        ...
        vegetables: {},
        condiments: {
          butter: ["piment d'espelette butter"]
        },
        spices: {}
      },
      cost: 2.0,
